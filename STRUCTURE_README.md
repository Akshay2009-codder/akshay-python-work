...
This repository contains my Python learning journey, including problem-solving, library practice, and project work.  
It reflects my hands-on practice with **Python, NumPy, Pandas**, and **Machine Learning fundamentals**, along with problem-solving platforms like **LeetCode**.
...
- Focus on logic building and problem-solving using Python.
...
### 🔹 PANDAS
- Practice codes related to the Pandas library.
- Covers:
  - DataFrames
  - Series
  - Data cleaning
...
### 🔹 ML PRACTICE
- Focus on Machine Learning **data preparation**
- Covers:
  - Data cleaning & preprocessing
  - Handling missing and invalid values
  - Feature engineering (numeric & categorical)
  - Date & time feature extraction
  - GroupBy & aggregation (department-wise analysis)
  - Statistical analysis (mean, std, ranking)
- Prepares datasets for ML models
